...
DEFAULT_MQTT_BROKER_IP = "ategee"
DEFAULT_MQTT_BROKER_PORT = 1883
DEFAULT_MQTT_TOPIC = "enviro"
...
# commenting out to turn off screen
    # Create LCD instance (this is a comment)
    # disp = ST7735.ST7735(
    #     port=0, cs=1, dc=9, backlight=12, rotation=270, spi_speed_hz=10000000
    # )
    # Initialize display (this is a comment)
    # disp.begin()
...
# commenting out next section in attempts to disable the display
...
# commenting this out to see if it can play nicely with weather-and-light
# they fight for the display
